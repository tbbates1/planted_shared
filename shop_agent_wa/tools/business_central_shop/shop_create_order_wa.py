"""Tool: create a new order (sales quote) in Business Central (WhatsApp shop agent)."""
...
@tool(
    ...
    name="shop_create_order_wa",
    description="Create a new order in Business Central. Pass item IDs and quantities from shop_get_products_wa. Customer is resolved automatically from phone_number context variable.",
)
def shop_create_order_wa(
    context: AgentRun,
    item_id_1: str,
    quantity_1: float,
    item_id_2: str = "",
    ...
    ext_doc_number = "WHATSAPP-ORDER"[:35]
