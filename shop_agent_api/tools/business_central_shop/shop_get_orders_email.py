"""Tool: get order history for a customer (email shop agent)."""
...
@tool(
    ...
    name="shop_get_orders_email",
    description="Get recent order history for a customer. Returns shipped orders and pending orders. Customer is resolved automatically from email_address context variable.",
)
def shop_get_orders_email(context: AgentRun, limit: int = 50) -> dict:
