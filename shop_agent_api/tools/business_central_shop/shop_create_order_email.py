"""Tool: create a new order (sales quote) in Business Central (email shop agent)."""
...
@tool(
    ...
    name="shop_create_order_email",
    description="Create a new order in Business Central. Pass item IDs and quantities from shop_get_products_email. Customer is resolved automatically from email_address context variable.",
)
def shop_create_order_email(
    context: AgentRun,
    item_id_1: str,
    quantity_1: float,
    item_id_2: str = "",
    ...
    """Create an order (draft sales quote) in Business Central.
